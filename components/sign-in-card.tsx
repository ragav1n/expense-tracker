...
export function Component({ isSignUp = false }: { isSignUp?: boolean }) {
  ...
  return (
    <div className="min-h-screen w-screen bg-background relative overflow-hidden flex items-center justify-center">
      {/* Cosmic Night background gradient */}
      <div className="absolute inset-0 bg-gradient-to-b from-primary/25 via-primary/10 to-background" />
      ...
      {/* Top radial glow - electric purple */}
      ...
      />
      <motion.div 
        className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-[90vh] h-[90vh] rounded-t-full bg-secondary/15 blur-[60px]"
        animate={{ 
      ...
      {/* Animated glow spots - cosmic accents */}
      <div className="absolute left-1/4 top-1/4 w-96 h-96 bg-primary/10 rounded-full blur-[100px] animate-pulse opacity-30" />
      <div className="absolute right-1/4 bottom-1/4 w-96 h-96 bg-secondary/10 rounded-full blur-[100px] animate-pulse delay-1000 opacity-30" />
                  ...
                  <motion.div className="space-y-3">
                    ...
                    >
                      ...
                      <div className="relative flex items-center overflow-hidden rounded-lg">
                        <Mail className={`absolute left-3 w-4 h-4 transition-all duration-300 ${
                          focusedInput === "email" ? 'text-primary' : 'text-foreground/40'
                        }`} />
                    ...
                    >
                      ...
                      <div className="relative flex items-center overflow-hidden rounded-lg">
                        <Lock className={`absolute left-3 w-4 h-4 transition-all duration-300 ${
                          focusedInput === "password" ? 'text-primary' : 'text-foreground/40'
                        }`} />
                    ...
                    {isSignUp && (
                      ...
                      >
                        ...
                        <div className="relative flex items-center overflow-hidden rounded-lg">
                          <Lock className={`absolute left-3 w-4 h-4 transition-all duration-300 ${
                            focusedInput === "confirmPassword" ? 'text-primary' : 'text-foreground/40'
                          }`} />
