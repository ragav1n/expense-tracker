...
export function FallingPattern({
    color = 'white', // Changed default to white/light for visibility on dark bg
    backgroundColor = 'transparent', // Changed to transparent to overlay on existing bg if needed, or keeping it as var(--background)
    duration = 150,
    blurIntensity = '1em',
    density = 1,
    className,
